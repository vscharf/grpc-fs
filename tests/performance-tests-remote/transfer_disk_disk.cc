...
void ClientGetFile(std::string remote, std::string local, std::string address = "192.168.0.247:50051") {
  grpc_init();
...
int main(int argc, char** argv) {
  ...
  if(argc == 1) {
    ...
    std::cerr << "Two positional arguments expected for client: <remote-file> <local-file>" << std::endl;
    return 1;
  }
